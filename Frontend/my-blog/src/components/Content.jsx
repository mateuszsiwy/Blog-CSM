    ...
    return (
        <div id="content" className="h-screen bg-[url(./assets/backContent.png)] bg-cover bg-center flex items-center justify-center z-0">
            ...
            <div className="flex flex-col items-center justify-center w-3/5 h-full">
                    ...
                    <img className="w-lg" src={logo} alt="Logo" />
                    <p className="text-[#cdad7d] text-3xl font-semibold">Agnieszka Siwy</p>
                    <p className="text-white text-lg italic pb-9">RADCZYNI PRAWNA</p>
                    <p className="text-[#cdad7d] text-xl tracking-[9px] ">KANCELARIA PRAWA PRACY</p>
                </div>
                <div className="w-2/6 h-full">
                    <ul className="list-none p-0 m-0 text-2xl h-full flex flex-col justify-center">
