    ...
    return (
      <section id="about" className="relative min-h-screen flex flex-col items-center justify-center bg-primary py-16 px-4" style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="max-w-8xl grid grid-cols-1 md:grid-cols-[30%_70%] gap-1 items-center">
          <div className="flex flex-col items-center w-full md:w-auto self-start">
            <h2 className="text-4xl md:text-7xl text-[#cdad7d] mb-8 md:mb-18">O mnie</h2>
            <img 
              src={portrait} 
              alt="Portret" 
          ...
          <div className="space-y-6 text-xl md:text-3xl">
            <div className="flex items-start gap-4">
              <img src={wskaznik} alt="wskaznik" className="w-12 h-12 md:w-16 md:h-16 object-contain mt-6" />
